...
app.use('/api/cms/team', require('./routes/cms/team')); // P39b: "Just me" solo profile
...
app.use('/api/cms/security', require('./routes/cms/security')); // P39k: account security notices (password, 2FA, new device)
...
app.use('/api/admin/leads', require('./routes/admin/leads')); // Google record refresh (2026-09-15)
