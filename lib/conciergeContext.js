...
// Stemfra earns a flat 5% commission on the sales made through the site, capped
// at $400 per site per month (decided 2026-09-17, public since 2026-09-22). NEVER
  ...
  return {
    company: {
      ...
      differentiators: [
        ...
        'Stemfra earns a flat 5% commission on the sales you make through your site, never more than $400 a month per location. We only earn when you do.',
    ...
    pricing: {
      model: 'commission',
      headline: 'Free website: no setup fee, no monthly fee, no contract. Stemfra earns a flat 5% commission on the sales you make through your Stemfra site, capped at $400 a month.',
    ...
    how_it_works: [
      ...
      'From then on, Stemfra earns a flat 5% on the sales you make through the site, never more than $400 a month, billed monthly by invoice.',
    ],
