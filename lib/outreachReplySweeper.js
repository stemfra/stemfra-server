...
async function sweepOnce() {
  ...
  const { data: leads, error } = await supabase
    .from('leads')
    .select('id, company_name, contact_name, email, phone, phone_country, do_not_call, pain_point_bucket, qualification, outreach_thread_id, outreach_sent_by, outreach_sent_at')
