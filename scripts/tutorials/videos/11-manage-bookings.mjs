...
export default {
  ...
  segments: [
    ...
    { id: 'cal-2',
      ...
      // The Day/Week toggle renders lowercase "day"/"week" text under CSS `capitalize`, and Playwright's text-is is case-sensitive: "Week" never matched (a silent 8s wait in every take before 2026-09-09).
